...
public class ClevrReasoning {
    ...
    public static void main(String[] args) throws OWLOntologyCreationException {
        ...
        inferredAxioms.add(new InferredClassAxiomGenerator());
        inferredAxioms.add(new InferredDataPropertyCharacteristicAxiomGenerator());
        inferredAxioms.add(new InferredEntityAxiomGenerator());
        ...
        inferredAxioms.add(new InferredIndividualAxiomGenerator());
        inferredAxioms.add(new InferredEquivalentDataPropertiesAxiomGenerator());
        inferredAxioms.add(new InferredObjectPropertyAxiomGenerator());
